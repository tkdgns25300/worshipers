...
export const team: Team = {
  ...
  nameEn: "YWAM Korea",
  description:
    "예수전도단(YWAM Korea)은 1960년 오대원(David E. Ross) 선교사가 시작한 사역에 뿌리를 두고 1980년 국제 선교단체 YWAM의 한국 지부가 된 초교파 선교단체입니다. '하나님을 알고 그를 알리자'를 슬로건으로, 매주 화요일 신용산교회에서 드리는 '화요모임'과 캠퍼스워십 등 찬양 사역으로 한국 교회에 오랜 영향을 끼쳐 왔습니다.",
